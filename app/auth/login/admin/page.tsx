  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-teal-50 p-4">
      <Card className="w-full max-w-md shadow-xl border-0">
        <CardHeader className="space-y-3 bg-gradient-to-br from-purple-600 to-red-600 text-white rounded-t-lg pt-8 pb-6">
        ...
        <CardContent className="pt-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg py-2"
              disabled={loading}
            >
